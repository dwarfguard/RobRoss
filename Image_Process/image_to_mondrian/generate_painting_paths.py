...
DEFAULT_CONFIG_FILE = "configs/image_to_mondrian_demo_a4.json"
...
def build_painting_paths(
    ...
    return {
        ...
        "style": config.get("style", "image_to_mondrian"),
        "version": "0.1",
        "config": {
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Convert a source photo into a 5-color Mondrian-style painting_paths.json."
    )
    parser.add_argument(
        "--config",
