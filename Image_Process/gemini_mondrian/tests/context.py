"""Shared test setup: make the gemini_mondrian module importable and expose repo paths.

The scripts live directly under Image_Process/gemini_mondrian/ and are not a
